...
page '/en/weddings/*', layout: 'en-eventspage'
page '/en/events/*', layout: 'en-eventspage'
page '/en/additional-services/*', layout: 'en-eventspage'
page '/en/privacy.html', layout: 'en-eventspage'
page '/en/request/*', layout: 'en-form'
page '/en/*', layout: 'en-layout'
